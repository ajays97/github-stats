# [GitHub Stats Visualization](https://github.com/ajays97/github-stats)
...
<img src="https://github.com/ajays97/github-stats/blob/master/generated/overview.svg#gh-light-mode-only" />
<img src="https://github.com/ajays97/github-stats/blob/master/generated/languages.svg#gh-light-mode-only" />
</a>
...
[#2](https://github.com/ajays97/github-stats/issues/2),
[#3](https://github.com/ajays97/github-stats/issues/3), and
[#13](https://github.com/ajays97/github-stats/issues/13).
...
1. Create a personal access token (not the default GitHub Actions token) using
   ...
   - Some users are reporting that it can take a few minutes for the personal
     ...
     [#30](https://github.com/ajays97/github-stats/issues/30).
2. Create a copy of this repository by clicking
   [here](https://github.com/ajays97/github-stats/generate). Note: this is
...
5. It is possible to change the type of statistics reported by adding other
   ...
   - To ignore certain repos, add them (in owner/name format e.g.,
     `ajays97/github-stats`) separated by commas to a new secret—created as
   ...
   - To show statistics only for "owned" repositories and not forks with
     ...
     [main
     workflow](https://github.com/ajays97/github-stats/blob/master/.github/workflows/main.yml))
   ...
   - These other values are added as secrets by default to prevent leaking
     ...
     itself](https://github.com/ajays97/github-stats/blob/05de1314b870febd44d19ad2f55d5e59d83f5857/.github/workflows/main.yml#L48-L53).
6. Go to the [Actions
